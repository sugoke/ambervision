    ...
    handleThemePanel = function() {
      ...
      [].slice.call(document.querySelectorAll("[" + app.themePanel.toggleAttr + "]")).map(function(e) {
        ...
        e.onclick = function() {
          ...
          a && document.body.classList.add(a), o.map(function(e) {
          ...
          }), this.closest("." + app.themePanel.themeListItemCLass).classList.add(app.themePanel.theme.activeClass), Cookies && (Cookies.set(app.themePanel.theme.cookieName, a), app.color.theme = getComputedStyle(document.body).getPropertyValue("--bs-theme").trim(), app.color.themeRgb = getComputedStyle(document.body).getPropertyValue("--bs-theme-rgb").trim(), document.dispatchEvent(new Event("theme-reload")))
        }
      }), Cookies && Cookies.get(app.themePanel.theme.cookieName) && (t = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "][" + app.themePanel.theme.classAttr + '="' + Cookies.get(app.themePanel.theme.cookieName) + '"]')) && (t.click(), app.color.theme = getComputedStyle(document.body).getPropertyValue("--bs-theme").trim(), app.color.themeRgb = getComputedStyle(document.body).getPropertyValue("--bs-theme-rgb").trim(), document.dispatchEvent(new Event("theme-reload"))), [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeCover.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
          e.preventDefault();
          for (var t = document.querySelector("html"), a = this.getAttribute(app.themePanel.themeCover.classAttr), o = 0; o < document.documentElement.classList.length; o++) {
            var s = document.documentElement.classList[o]; - 1 < s.search("bg-cover-") && t.classList.remove(s)
          }
          a && t.classList.add(a), [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeCover.toggleAttr + "]")).map(function(e) {
          ...
          }), this.closest("." + app.themePanel.themeCoverItemClass).classList.add(app.themePanel.themeCover.activeClass), Cookies && Cookies.set(app.themePanel.themeCover.cookieName, a)
        }
      }), Cookies && Cookies.get(app.themePanel.themeCover.cookieName) && (t = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeCover.toggleAttr + "][" + app.themePanel.themeCover.classAttr + '="' + Cookies.get(app.themePanel.themeCover.cookieName) + '"]')) && t.click(), [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeMode.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
          e.preventDefault();
          var t = this,
            e = t.getAttribute(app.themePanel.themeMode.valueAttr) ? t.getAttribute(app.themePanel.themeMode.valueAttr) : "";
          "dark" == e ? document.querySelector("html").setAttribute(app.themePanel.themeMode.attr, e) : document.querySelector("html").removeAttribute(app.themePanel.themeMode.attr), Cookies && Cookies.set(app.themePanel.themeMode.cookieName, e), t.classList.add(app.themePanel.themeMode.activeClass), [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeMode.toggleAttr + "]")).map(function(e) {
            e != t && e.classList.remove(app.themePanel.themeMode.activeClass)
          }), handleCssVariable(), document.dispatchEvent(new CustomEvent("theme-reload"))
        }
    ...
    App = function() {
      ...
      return {
        ...
        initComponent: function() {
          handleScrollbar(), handleScrollToTopButton(), handleScrollTo(), handleCardAction(), handelTooltipPopoverActivation(), handleToggleClass(), handleThemePanel(), handleCssVariable()
        },
        scrollTop: function() {
          window.scrollTo({
            top: 0,
